...
void initialise()
{
	...
	for (int i = 0; i < MAX; i++)
	{
		...
		if (i == 0)
			...
			c[i].x = c[i - 1].x + 90.0; //distance between circles 
...
void int_str(int rad, char r[])
{
	switch (rad)
	{
	case 1: strcpy_s(r, 2, "1"); break;
	case 2: strcpy_s(r, 2, "2"); break;
	case 3: strcpy_s(r, 2, "3"); break;
	case 4: strcpy_s(r, 2, "4"); break;
	case 5: strcpy_s(r, 2, "5"); break;
	case 6: strcpy_s(r, 2, "6"); break;
	case 7: strcpy_s(r, 2, "7"); break;
	case 8: strcpy_s(r, 2, "8"); break;
	case 9: strcpy_s(r, 2, "9"); break;
		//case 10:strcpy_s(r, 2, "10"); break;
	}
...
SWAP:
	char c1[100] = "Swapping ->";
	printf("swapping --> %d - %d\n", global_j, global_j + 1);
	bitmap_output(10, 375, c1, GLUT_BITMAP_9_BY_15);
...
void display_text()
{
	char c1[100] = "DYNAMIC SORTING ALGORITHM VISUALISER";
	bitmap_output(200, 565, c1, GLUT_BITMAP_TIMES_ROMAN_24);//title larger font
	...
	char c2[100] = "This program sorts a random set of numbers in ascending order displaying them graphically as ";
	char c3[100] = "circles with varying radii.";
	bitmap_output(10, 525, c2, GLUT_BITMAP_9_BY_15);
	bitmap_output(10, 505, c3, GLUT_BITMAP_9_BY_15);


	if (sorting == 0)//if not sorting display menu
	{
		char c4[100] = "MENU";
		char c5[100] = "Press s to SORT";
		char c6[100] = "Press r to RANDOMISE";
		char c7[100] = "Esc to QUIT";
		bitmap_output(10, 455, c4, GLUT_BITMAP_9_BY_15);
		bitmap_output(10, 435, c5, GLUT_BITMAP_9_BY_15);
		bitmap_output(10, 415, c6, GLUT_BITMAP_9_BY_15);
		bitmap_output(10, 395, c7, GLUT_BITMAP_9_BY_15);
	}
	else if (sorting == 1)
	{
		glColor3f(0.5, 0.5, 0.5);
		char c8[100] = "Sorting in progress...";
		char c9[100] = "Please do not quit";
		bitmap_output(10, 455, c8, GLUT_BITMAP_9_BY_15);
		bitmap_output(10, 435, c9, GLUT_BITMAP_9_BY_15);
		glColor3f(0.0, 0.0, 0.0);
	}
...
void front()
{
	char c1[100] = "WELCOME!";
	char c2[100] = "TO";
	char c3[100] = "DYNAMIC SORTING ALGORITHM VISUALISER";
	char c4[100] = "Press Enter to continue.......";


	glColor3f(0.0, 0.0, 1.0);
	bitmap_output(390, 565, c1, GLUT_BITMAP_TIMES_ROMAN_24);
	glBegin(GL_LINE_LOOP);
	glVertex2f(388, 560);
	glVertex2f(524, 560);
	glEnd();
	bitmap_output(440, 535, c2, GLUT_BITMAP_TIMES_ROMAN_24);
	glBegin(GL_LINE_LOOP);
	glVertex2f(438, 531);
	glVertex2f(475, 531);
	glEnd();

	bitmap_output(200, 495, c3, GLUT_BITMAP_TIMES_ROMAN_24);
	glBegin(GL_LINE_LOOP);
	glVertex2f(198, 490);
	glVertex2f(731, 490);
	glEnd();
	...
	bitmap_output(600, 125, c4, GLUT_BITMAP_HELVETICA_18);
